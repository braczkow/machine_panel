...
${OBJECTDIR}/LcdView.o: LcdView.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LcdView.o LcdView.cpp

${OBJECTDIR}/MachineModel.o: MachineModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MachineModel.o MachineModel.cpp

${OBJECTDIR}/PanelConfig.o: PanelConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PanelConfig.o PanelConfig.cpp
...
${OBJECTDIR}/PanelScene.o: PanelScene.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PanelScene.o PanelScene.cpp
...
${OBJECTDIR}/mach/MachineClient.o: mach/MachineClient.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mach/MachineClient.o mach/MachineClient.cpp

${OBJECTDIR}/mach/MachineService.o: mach/MachineService.cpp 
	${MKDIR} -p ${OBJECTDIR}/mach
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mach/MachineService.o mach/MachineService.cpp
