...
${OBJECTDIR}/MachineClient.o: MachineClient.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MachineClient.o MachineClient.cpp
...
${OBJECTDIR}/PanelMachineModel.o: PanelMachineModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PanelMachineModel.o PanelMachineModel.cpp
...
${OBJECTDIR}/RemoteDevice.o: RemoteDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RemoteDevice.o RemoteDevice.cpp
