...
# CC Compiler Flags
CCFLAGS=-std=c++11 -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -L/usr/lib/arm-linux-gnueabihf -lSDL
CXXFLAGS=-std=c++11 -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT -L/usr/lib/arm-linux-gnueabihf -lSDL
...
LDLIBSOPTIONS=-lboost_filesystem -lboost_system -lwiringPi -lpthread -lwiringPiDev -lSDL_ttf
...
${OBJECTDIR}/Ili9341View.o: Ili9341View.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ili9341View.o Ili9341View.cpp
...
${OBJECTDIR}/MessageHandler.o: MessageHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MessageHandler.o MessageHandler.cpp
...
${OBJECTDIR}/RemoteControlServer.o: RemoteControlServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RemoteControlServer.o RemoteControlServer.cpp

${OBJECTDIR}/RemoteControlSession.o: RemoteControlSession.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RemoteControlSession.o RemoteControlSession.cpp
...
${OBJECTDIR}/TFTViewEngine.o: TFTViewEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TFTViewEngine.o TFTViewEngine.cpp
